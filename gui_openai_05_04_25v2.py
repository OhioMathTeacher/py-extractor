...
class PDFExtractorGUI(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("Search Buddy GUI")  # updated title  # updated title
...
if __name__ == "__main__":
    ...
    app_qt.setApplicationName("Search Buddy GUI")  # updated application name  # Set menu bar app title
